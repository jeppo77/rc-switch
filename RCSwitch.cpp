 ...
 *
 */
bool ICACHE_RAM_ATTR __attribute__((always_inline)) RCSwitch::receiveProtocol(const int p, unsigned int changeCount) {
#ifdef ESP8266
...
void ICACHE_RAM_ATTR __attribute__((always_inline)) RCSwitch::handleInterrupt() {
